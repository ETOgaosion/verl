...
ROLLOUT_TP=${ROLLOUT_TP:-$COMMON_TP}
...
RM_TP=${RM_TP:-$COMMON_TP}

NUM_LAYERS_IN_FIRST_PP_STAGE=${NUM_LAYERS_IN_FIRST_PP_STAGE}
NUM_LAYERS_IN_LAST_PP_STAGE=${NUM_LAYERS_IN_LAST_PP_STAGE}
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.actor.megatron.override_transformer_config.num_layers_in_first_pipeline_stage=$NUM_LAYERS_IN_FIRST_PP_STAGE \
    actor_rollout_ref.actor.megatron.override_transformer_config.num_layers_in_last_pipeline_stage=$NUM_LAYERS_IN_LAST_PP_STAGE \
    ...
    actor_rollout_ref.ref.megatron.override_transformer_config.num_layers_in_first_pipeline_stage=$NUM_LAYERS_IN_FIRST_PP_STAGE \
    actor_rollout_ref.ref.megatron.override_transformer_config.num_layers_in_last_pipeline_stage=$NUM_LAYERS_IN_LAST_PP_STAGE \
    ...
    critic.megatron.override_transformer_config.num_layers_in_first_pipeline_stage=$NUM_LAYERS_IN_FIRST_PP_STAGE \
    critic.megatron.override_transformer_config.num_layers_in_last_pipeline_stage=$NUM_LAYERS_IN_LAST_PP_STAGE \
    ...
    reward_model.megatron.override_transformer_config.num_layers_in_first_pipeline_stage=$NUM_LAYERS_IN_FIRST_PP_STAGE \
    reward_model.megatron.override_transformer_config.num_layers_in_last_pipeline_stage=$NUM_LAYERS_IN_LAST_PP_STAGE \
